...
public interface TechnicianRepository extends MongoRepository<Technician, String> {
	...
	List<Technician> findByCityAndStatusAndAvailability(String city, TechnicianStatus status,
			AvailabilityStatus availability);

	Optional<Technician> findFirstByStatusAndAvailabilityAndSkillCategoryIdsContaining(
            TechnicianStatus status,
            AvailabilityStatus availability,
            String categoryId
    );

	List<Technician> findByStatusAndAvailability(TechnicianStatus status, AvailabilityStatus availability);
